...
const AUTH_API_URL = process.env.EXPO_PUBLIC_AUTH_API_URL || 'http://192.168.240.124:5001';
const DELIVERY_API_URL = process.env.EXPO_PUBLIC_DELIVERY_API_URL || 'http://192.168.240.124:5004';
const ORDER_API_URL = process.env.EXPO_PUBLIC_ORDER_API_URL || 'http://192.168.240.124:5002';
...
export const trackDeliveryAPI = async (deliveryId: string) => {
  const res = await deliveryApi.get(`/api/deliveries/${deliveryId}/track`);
